...
const SAMPLE_PRODUCTS = [
  {
    ...
    priceCents: 29900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-velocity-jacket.dim_600x700.jpg",
    stock: 15,
    gender: "Male",
  },
  {
    ...
    priceCents: 45900,
    category: "Gear",
    imageUrl: "/assets/generated/v7-speed-helmet.dim_600x700.jpg",
    stock: 8,
    gender: "Male",
  },
  {
    ...
    priceCents: 8900,
    category: "Gear",
    imageUrl: "/assets/generated/v7-carbon-gloves.dim_600x700.jpg",
    stock: 30,
    gender: "Male",
  },
  {
    ...
    priceCents: 14900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-track-pants.dim_600x700.jpg",
    stock: 20,
    gender: "Male",
  },
  {
    ...
    priceCents: 38900,
    category: "Footwear",
    imageUrl: "/assets/generated/v7-racing-boots.dim_600x700.jpg",
    stock: 12,
    gender: "Male",
  },
  {
    ...
    priceCents: 21900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-aerodynamic-vest.dim_600x700.jpg",
    stock: 18,
    gender: "Male",
  },
];
...
const FEMALE_PRODUCTS = [
  {
    ...
    priceCents: 27900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-female-bomber-jacket.dim_600x700.jpg",
    stock: 14,
    gender: "Female",
  },
  {
    ...
    priceCents: 12900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-female-leggings.dim_600x700.jpg",
    stock: 28,
    gender: "Female",
  },
  {
    ...
    priceCents: 7900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-female-sports-bra.dim_600x700.jpg",
    stock: 32,
    gender: "Female",
  },
  {
    ...
    priceCents: 34900,
    category: "Footwear",
    imageUrl: "/assets/generated/v7-female-sneakers.dim_600x700.jpg",
    stock: 18,
    gender: "Female",
  },
  {
    ...
    priceCents: 17900,
    category: "Apparel",
    imageUrl: "/assets/generated/v7-female-hoodie-vest.dim_600x700.jpg",
    stock: 20,
    gender: "Female",
  },
  {
    ...
    priceCents: 6900,
    category: "Gear",
    imageUrl: "/assets/generated/v7-female-fashion-gloves.dim_600x700.jpg",
    stock: 22,
    gender: "Female",
  },
];
...
export function ShopPage() {
  ...
  const backendMapped: DisplayProduct[] = (backendProducts || []).map((p) => ({
    ...
    category: p.category,
    imageUrl:
      p.imageUrl || "/assets/generated/v7-velocity-jacket.dim_600x700.jpg",
